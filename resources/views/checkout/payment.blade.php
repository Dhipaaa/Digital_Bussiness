...
<script>
    ...
    // Membuka popup otomatis saat halaman dibuka
    // Hanya auto-open popup jika berada di path payment (mencegah muncul di halaman lain)
    if (window.location.pathname && window.location.pathname.indexOf('/payment') !== -1) {
        window.addEventListener('load', function() {
            if (payButton) {
                // beri delay kecil agar DOM & snap.js siap
                setTimeout(function() {
                    payButton.click();
                }, 250);
            }
