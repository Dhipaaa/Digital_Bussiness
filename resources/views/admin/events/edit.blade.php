    ...
    <form action="{{ route('admin.events.update', $event->id) }}"
        ...
        <div class="mb-4">
            ...
            <input type="text" name="title"
                ...
                class="w-full border {{ $errors->has('title') ? 'border-red-500 bg-red-50' : 'border-gray-300' }} p-2.5 rounded focus:ring focus:ring-blue-200"
                required>
            @error('title')
        ...
        <div class="mb-4">
            ...
            <select name="category_id"
                class="w-full border {{ $errors->has('category_id') ? 'border-red-500 bg-red-50' : 'border-gray-300' }} p-2.5 rounded"
                required>
        ...
        <div class="mb-4">
            ...
            <textarea name="description"
                class="w-full border {{ $errors->has('description') ? 'border-red-500 bg-red-50' : 'border-gray-300' }} p-2.5 rounded"
                rows="3"
