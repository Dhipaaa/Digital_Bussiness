...
<body class="bg-indigo-50/30 text-slate-900">
        ...
        <div class="grid grid-cols-1 gap-8">
            ...
            <div class="bg-white rounded-3xl border border-slate-200 p-8 shadow-sm">
                <h3 class="text-xl font-bold mb-6 italic text-indigo-600 underline underline-offset-8">📦 Data Pemesan
                    (Tanpa Login)</h3>
                <form action="{{ route('checkout.store', request()->query('event')) }}" method="POST" class="space-y-6">
                    @csrf
                    <div>
    ...
    <!-- Removed Midtrans simulation overlay; real flow posts to CheckoutController@store -->
